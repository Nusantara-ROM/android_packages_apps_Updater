...
updates_dir=/data/nusantara_updates
...
adb shell "killall org.nusantara.updater 2>/dev/null"
adb shell "sqlite3 /data/data/org.nusantara.updater/databases/updates.db" \
