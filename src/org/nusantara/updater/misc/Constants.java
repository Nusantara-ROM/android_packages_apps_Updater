 ...
 */
package org.nusantara.updater.misc;
...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.nad.build.version";
    public static final String PROP_DEVICE = "ro.nad.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.nad.build.type";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "nad.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "nad.updater.uri";
